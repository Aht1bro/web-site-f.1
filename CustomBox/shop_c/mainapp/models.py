...
class Product(models.Model):
    ...
    #     return self.pub_date >= (timezone.now() - datetime.date.timedelta(days = 7))
...
class Sweatshirt(Product):
    ...
    def get_absolute_url(self):
        return get_product_url(self, 'tovar')
...
class Hoodie(Product):
    ...
    class Meta:
        verbose_name = 'Толстовку'
        verbose_name_plural = 'Толстовки'
